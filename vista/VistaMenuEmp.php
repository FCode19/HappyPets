...
require_once '../persistencia/Conexion.php'; // Asegúrate de incluir esto para usar lastInsertId()
...
if (isset($_POST['btnRegistrar']) || isset($_POST['btnActualizar'])) {
    ...
    if (isset($_POST['btnActualizar'])) {
        // Obtener ID de la mascota a actualizar
        $idMascota = $_POST['idMascota'];
                    ...
                    <div class="card-body row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                <input type='checkbox' class='form-check-input' name='vacunas[]' value='$v' $checked> $v
                            </label>";
                                }
                                ?>
                            </div>
